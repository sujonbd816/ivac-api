...
const oj = ({message: n, type: l="info", onClose: s}) => {
  ...
  , Ot = ({message: n, type: l="info", onClose: s}) => {
    const [o,u] = j.useState(!0)
      , h = () => {
        u(!1),
        n === "Session expired. Please log in again." && 
        window.location.href = "/"),
        s && s()
    }
    ;
    ...
    const [l,s] = j.useState(null)
      ...
      , v = async () => {
        ...
        try {
            ...
            M.status_code === 200 ? N((E = M == null ? void 0 : M.data) == null ? void 0 : E.slot_available, (_ = M == null ? void 0 : M.data) == null ? void 0 : _.ivac_fees) : M.status_code === 200 ? 
