        ...
        f.jsxs("div", {
            ...
            children: [
                f.jsx("input", {
                    ...
                    placeholder: (o?.enterCaptcha?.[s]) || "Enter code"
                }),
                f.jsx("button", {
                    type: "button",
                    disabled: false, // সবসময় active
                    ...
                    children: (o?.verify?.[s]) || "Verify" // সবসময় "Verify" দেখাবে
                })
            ]
        }),
        f.jsx("p", {
            className: "text-xs text-red-500 mt-0",
            children: qt || "" // error message থাকলে দেখাবে, না থাকলে খালি
        })
    ]
})
