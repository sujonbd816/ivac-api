      ...
      , G = async () => {
        try {
            ...
            const we = ne
              ...
              , Gt = typeof we == "object" && typeof we.status == "number" ? we.status : 200;
            (Gt === 401 || Gt === 4191) && (c({
                message: gt,
                type: "error"
            }),
      ...
      , v = async () => {
        ...
        try {
            ...
            const te = $
              ...
              , se = typeof te == "object" && typeof te.status == "number" ? te.status : 200;
            (se === 401 || se === 4191) && (g({
                message: J,
                type: "error"
            }),
      ...
      , x = async () => {
        try {
            ...
            const B = L
              ...
              , R = typeof B == "object" && typeof B.status == "number" ? B.status : 200;
            (R === 401 || R === 4191) && (m({
                message: F,
                type: "error"
            }),
...
const iw = ({setStep: n}) => {
    ...
    const F = async () => {
        ...
        try {
            ...
            const N = H
              ...
              , q = typeof N == "object" && typeof N.status == "number" ? N.status : 200;
            (q === 401 || q === 4191) && (S({
                message: O,
                type: "error"
            }),
    ...
    const R = async () => {
        ...
        try {
            ...
            const k = j
              ...
              , K = typeof k == "object" && typeof k.status == "number" ? k.status : 200;
            (K === 401 || K === 4191) && (S({
                message: X,
                type: "error"
            }),
    ...
    children: [
        f.jsx(oe.button, {
            ...
            className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: R,
            children: s?.lblProceed?.[l] // সরাসরি Proceed টেক্সট, checking বাদ
        }),
        f.jsx(oe.button, {
            onClick: F,
            className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            children: s?.resendOtp?.[l] // সবসময় Active, countdown বাদ
        })
    ]
})]
    })
  ...
  , ow = ({setStep: n}) => {
    ...
    className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: R,
    children: (de = s == null ? void 0 : s.lblProceed) == null ? void 0 : de[l] // শুধুই Proceed টেক্সট
}), f.jsx(oe.button, {
    onClick: F,
    className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    children: (re = s == null ? void 0 : s.resendOtp) == null ? void 0 : re[l] // শুধুই Resend OTP
})]
    })
}
  , rw = ({setStep: n}) => {
      ...
      , x = async () => {
        ...
        try {
            ...
            const R = F
              ...
              , te = typeof R == "object" && typeof R.status == "number" ? R.status : 200;
            (te === 401 || te === 4191) && (g({
                message: $,
                type: "error"
            }),
  ...
  , cw = ({setStep: n}) => {
    ...
    const L = async () => {
        ...
        try {
            ...
            const ae = q
              ...
              , k = typeof ae == "object" && typeof ae.status == "number" ? ae.status : 200;
            (k === 401 || k === 4191) && (v({
                message: j,
                type: "error"
            }),
      ...
      , B = async () => {
        ...
        try {
            ...
            const H = ee
              ...
              , O = typeof H == "object" && typeof H.status == "number" ? H.status : 200;
            (O === 401 || O === 4191) && (v({
                message: N,
                type: "error"
            }),
    ...
    className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: L,
    children: (pe = s == null ? void 0 : s.lblProceed) == null ? void 0 : pe[l] // শুধু Proceed টেক্সট
}), f.jsx(oe.button, {
    onClick: B,
    className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    children: (de = s == null ? void 0 : s.resendOtp) == null ? void 0 : de[l] // শুধু Resend OTP
})]
    })
}
  , fw = ({setStep: n}) => {
      ...
      , w = async () => {
        ...
        try {
            ...
            const ee = re
              ...
              , N = typeof ee == "object" && typeof ee.status == "number" ? ee.status : 200;
            (N === 401 || N === 4191) && (x({
                message: H,
                type: "error"
            }),
  ...
  , dw = ({setStep: n}) => {
    ...
    const F = async () => {
        ...
        try {
            ...
            const X = k
              ...
              , le = typeof X == "object" && typeof X.status == "number" ? X.status : 200;
            (le === 401 || le === 4191) && (S({
                message: K,
                type: "error"
            }),
      ...
      , R = async () => {
        ...
        try {
            ...
            const O = N
              ...
              , ae = typeof O == "object" && typeof O.status == "number" ? O.status : 200;
            (ae === 401 || ae === 4191) && (S({
                message: q,
                type: "error"
            }),
    ...
    className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: F, // সবসময় কল হবে
    children: (re = s == null ? void 0 : s.lblProceed) == null ? void 0 : re[l] // শুধু Proceed টেক্সট
}), f.jsx(oe.button, {
    onClick: R, // সবসময় কল হবে
    className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    children: (ee = s == null ? void 0 : s.resendOtp) == null ? void 0 : ee[l] // শুধু Resend OTP
})]
    ...
    const G = async () => {
        try {
            ...
            const be = ie
              ...
              , Me = typeof be == "object" && typeof be.status == "number" ? be.status : 200;
            (Me === 401 || Me === 4191) && (p({
      ...
      , ge = async ie => {
        ...
        try {
            ...
            const Me = nt
              ...
              , Je = typeof Me == "object" && typeof Me.status == "number" ? Me.status : 200;
            (Je === 401 || Je === 4191) && (p({
                message: "Unauthorized, session timed out",
                type: "error"
            }),
...
` + H[0],
        ...
        if (de) {
            ...
            try {
                ...
                const ve = G
                  ...
                  , xe = typeof ve == "object" && typeof ve.status == "number" ? ve.status : 200;
                (xe === 401 || xe === 4191) && (g({
                    message: ge,
                    type: "error"
                }),
        ...
        if (ve && ge)
            try {
                ...
                const Be = xe
                  ...
                  , He = typeof Be == "object" && typeof Be.status == "number" ? Be.status : 200;
                (He === 401 || He === 4191) && Ht(l),
                g({
                    message: _e,
                    type: "error"
  ...
  , xw = ({setActiveStep: n}) => {
      ...
      , Ea = async () => {
        try {
            ...
            const fe = ce
              ...
              , Ne = typeof fe == "object" && typeof fe.status == "number" ? fe.status : 200;
            (Ne === 401 || Ne === 4191) && (h({
                message: Ue,
                type: "error"
            }),
        ...
        (async () => {
            ...
            try {
                ...
                const Jt = ft
                  ...
                  , ia = typeof Jt == "object" && typeof Jt.status == "number" ? Jt.status : 200;
                (ia === 401 || ia === 4191) && (h({
                    message: kn,
                    type: "error"
                }),
    ...
    const Sa = async ce => {
        ...
        try {
            ...
            const Ne = Ue
              ...
              , sa = typeof Ne == "object" && typeof Ne.status == "number" ? Ne.status : 200;
            (sa === 401 || sa === 4191) && (h({
                message: Pe,
                type: "error"
            }),
      ...
      , zt = async () => {
        ...
        try {
            ...
            const Ue = fe
              ...
              , Pe = typeof Ue == "object" && typeof Ue.status == "number" ? Ue.status : 200;
            (Pe === 401 || Pe === 4191) && (h({
                message: Ne,
                type: "error"
            }),
    ...
    children: [
        f.jsx("button", { onClick: D ? la : Ca, className: `bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors duration-200 hover:bg-green-700 hover:cursor-pointer`, children: o?.lblInputSentOtp?.[s] || "Submit" /* Input Sent OTP / Submit button */ }),
        f.jsx("button", { onClick: R, className: `bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-md transition-colors duration-200 hover:bg-green-700 hover:cursor-pointer`, children: o?.resendOtp?.[s] || "Resend OTP" /* Resend OTP button */ })
    ]
})]
                        })]
                    }), F && f.jsx("div", {
                        ...
                        children: [f.jsx("label", {
							...
							children: (Ct = o == null ? void 0 : o.verify) == null ? void 0 : Ct[s] 
						})
						]
                        })]
                    }), F && f.jsxs("div", {
    ...
    type: "button",
    onClick: j.length === 6 ? ka : void 0,
    disabled: j.length !== 6,
    className: `h-10 px-4 text-sm font-medium rounded-md text-white transition-colors duration-300 ${
        j.length === 6
            ? "bg-green-600 hover:bg-green-700 hover:cursor-pointer"
            : "bg-gray-400 cursor-not-allowed"
    }`,
    children: o?.verify?.[s] || "Verify"
})
]
                        }), f.jsx("div", {
                            className: "w-full flex items-center gap-2",
      ...
      , $ = async () => {
        try {
            ...
            const G = Z
              ...
              , ge = typeof G == "object" && typeof G.status == "number" ? G.status : 200;
            (ge === 401 || ge === 4191) && Ht(n),
            m({
                message: ve,
                type: "error"
