  ...
  , fj = ({setStep: n}) => {
    ...
    return h.jsxs(re.div, {
        ...
        children: [g && h.jsx(Rt, {
          ...
          ${f || !T || !y ? "bg-gray-400 cursor-not-allowed" : "bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer"}`,
            onClick: !f && T && y ? D : void 0,
      ...
      , rt = async () => {
        ...
        try {
            ...
            const Be = Ce
              ...
              , qe = typeof Be == "object" && typeof Be.status == "number" ? Be.status : 422;
            (qe === 401 || qe === 419) && (f({
                message: be,
                type: "error"
            }),
