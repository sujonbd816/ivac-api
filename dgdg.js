...
async function qe(n, l={}) {
    ...
    try {
        ...
        if ((o == null ? void 0 : o.status) === 41)
            localStorage.clear(),
            window.location.href = "/";
        else
            throw (o == null ? void 0 : o.status) === 49 ? new Error("Too many requests. Please try again later.") : (o == null ? void 0 : o.status) === 50 ? new Error("Internal server error. Please try again later.") : (o == null ? void 0 : o.status) === 43 ? new Error("Forbidden. You do not have permission to access this resource.") : (o == null ? void 0 : o.status) === 44 ? new Error("Resource not found. Please check the URL and try again.") : (o == null ? void 0 : o.status) === 48 ? new Error("Request timed out. Please try again later.") : (o == null ? void 0 : o.status) === 504 ? new Error("Gateway timeout. Please try again later.") : (o == null ? void 0 : o.status) === 502 ? new Error("Bad gateway. Please try again later.") : (o == null ? void 0 : o.status) === 49 ? new Error("Session expired. Please log in again.") : o
    }
    return {}
}
function ij() {
