...
` + H[0],
  ...
  , xw = ({setActiveStep: n}) => {
    ...
    children: [
        ...
        f.jsx("label", {
            className: "block text-sm font-medium text-gray-700 mb-2",
            children: o && o.lblInputAppointDate && s in o.lblInputAppointDate ? o.lblInputAppointDate[s] : "Select Appointment Date"
        }),
        // Select box
        f.jsxs("select", {
            id: "appointment_date",
            ...
            children: [
                ...
                f.jsx("option", {
                    ...
                    disabled: true,
                    hidden: true,
                    children: o && o.lblInputAppointment && s in o.lblInputAppointment ? o.lblInputAppointment[s] : "Select date"
                }),
                // Dynamic options
                $ && Object.entries($).map(([ce, fe]) =>
                    f.jsx("option", { value: fe, children: fe }, ce)
                )
            ]
        })
    ]
