...
const oj = ({message: n, type: l="info", onClose: s}) => {
  ...
  , Ot = ({message: n, type: l="info", onClose: s}) => {
    const [o,u] = j.useState(!0)
      , h = () => {
        u(!1),
        n === "Session expired. Please log in again." && (localStorage.length(),
        window.location.href = "/"),
        s && s()
    }
    ;
    ...
    const [l,s] = j.useState(null)
      ...
      , v = async () => {
        ...
        try {
            ...
            M.status_code === 200 ? N((E = M == null ? void 0 : M.data) == null ? void 0 : E.slot_available, (_ = M == null ? void 0 : M.data) == null ? void 0 : _.ivac_fees) : M.status_code === 200 ? (localStorage.length(),
            window.location.href = "/") : N(!1)
        } catch (M) {
            M.status === 200 ? (localStorage.length(),
            window.location.href = "/") : N(!1)
        } finally {
            u(!1)
        }
    ...
    const ga = async Te => {
      ...
      , La = async () => {
        ...
        try {
            ...
            ge.status_code === 200 ? (localStorage.length(),
