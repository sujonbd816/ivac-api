...
const nj = ({message: n, type: l="info", onClose: s}) => {
  ...
  , rj = ({setStep: n}) => {
    ...
    className: `text-white mb-2 h-8 rounded-lg text-xs w-full duration-300 
        sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: S, // সবসময় ফাংশন চালাবে
    children: (U = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
})
]
    })
}
  , uj = ({setStep: n}) => {
    ...
    return f.jsxs(oe.div, {
        ...
        children: [o && f.jsx(Rt, {
            ...
            children: [f.jsxs("p", {
                ...
                type: "button",
                onClick: xe && !re ? Be : void 0,
                disabled: !xe || re,
                className: `text-xs font-medium rounded px-2 py-1.5 mr-2 mb-2 transition-colors duration-200
                  ${!xe || re ? "text-gray-400 bg-gray-300 cursor-not-allowed" : "text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 cursor-pointer"}`,
                children: re ? (be = s == null ? void 0 : s.checking) == null ? void 0 : be[l] : (nt = s == null ? void 0 : s.verifyOtp) == null ? void 0 : nt[l]
            })]
        }), f.jsxs("p", {
    ...
    type: "button",
    disabled: false, // সবসময় enable
    whileTap: { scale: .95 },
    className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] cursor-pointer`,
    onClick: G, // সবসময় ফাংশন চালাবে
    children: (on = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
})
]
    })
}
  , cj = ({setStep: n}) => {
    ...
    className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: v, // সবসময় ফাংশন চালাবে
    children: (L = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
})
]
        }), f.jsx("p", {
...
const iw = ({setStep: n}) => {
    ...
    return f.jsxs(oe.div, {
        ...
        children: [x && f.jsx(Rt, {
            ...
            value: d,
            maxLength: 6,
            onCopy: H => H.preventDefault(),
            onPaste: H => H.preventDefault(),
            onCut: H => H.preventDefault(),
            onChange: H => {
    ...
    children: [
        f.jsx(oe.button, {
            ...
            className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: R,
            children: (de = s?.lblProceed)?.[l] || "Proceed"
        }),
        f.jsx(oe.button, {
            type: "button",
            disabled: false,
            ...
            className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: F,
            children: (re = s?.resendOtp)?.[l] || "Resend OTP"
        })
    ]
})
]
  ...
  , uw = ({setStep: n}) => {
    ...
    className: `text-white mb-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: S, // সবসময় ফাংশন কল হবে
    children: (F = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
})
]
    })
}
  , cw = ({setStep: n}) => {
    ...
    children: [
        f.jsx(oe.button, {
            ...
            className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: L, // সবসময় ফাংশন কল হবে
            children: (pe = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
        }),
        f.jsx(oe.button, {
            type: "button",
            disabled: false, // সবসময় enabled
            ...
            className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: B, // সবসময় ফাংশন কল হবে
            children: (de = s?.resendOtp)?.[l] || "Resend OTP" // শুধু Resend OTP দেখাবে
        })
    ]
})
]
  ...
  , fw = ({setStep: n}) => {
    ...
    className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
        bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
    onClick: w, // সবসময় ফাংশন কল হবে
    children: (te = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
})
]
    })
}
  , dw = ({setStep: n}) => {
    ...
    children: [
        f.jsx(oe.button, {
            ...
            className: `text-white mb-2 mt-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: F, // সবসময় ফাংশন কল হবে
            children: (re = s?.lblProceed)?.[l] || "Proceed" // শুধু Proceed দেখাবে
        }),
        f.jsx(oe.button, {
            type: "button",
            disabled: false, // সবসময় enabled
            ...
            className: `text-white mb-2 mt-2 md:ml-2 h-8 rounded-lg text-xs w-full sm:w-auto px-2 py-2 text-center transition 
                bg-[#28a745] hover:bg-[#218838] focus:ring-[#218838] cursor-pointer`,
            onClick: R, // সবসময় ফাংশন কল হবে
            children: (ee = s?.resendOtp)?.[l] || "Resend OTP" // শুধু Resend OTP দেখাবে
        })
    ]
})
]
  ...
  , gw = ({setActiveStep: n}) => {
    ...
    return j ? f.jsx(Ry, {}) : f.jsxs("div", {
        ...
        children: [d && f.jsx(Rt, {
            ...
            children: [f.jsxs("div", {
                ...
                children: [f.jsxs("label", {
                    ...
                    children: f.jsx("input", {
                        ...
                        name: "webfile_id",
                        id: "webfile_id",
                        onCopy: ie => ie.preventDefault(),
                        onPaste: ie => ie.preventDefault(),
                        onCut: ie => ie.preventDefault(),
                        maxLength: 12,
                        autoComplete: "off",
                        value: S,
                        onChange: ie => {
            ...
            `,
                    children: [(zt = s == null ? void 0 : s.checking) == null ? void 0 : zt[l], "..."]
                }) : f.jsx(oe.button, {
                    type: "button",
                    disabled: !xe || !X,
                    whileTap: {
              ...
              ${!xe || !X ? "bg-gray-400 cursor-not-allowed" : "bg-[#28a745] hover:bg-[#218838] "}
            `,
                    onClick: xe ? Be : void 0,
        ...
        children: g ? f.jsxs(oe.div, {
            ...
            children: [p && f.jsx(Rt, {
                ...
                children: [f.jsx("p", {
                    ...
                    autoComplete: "off",
                    maxLength: 6,
                    onCopy: Z => Z.preventDefault(),
                    onPaste: Z => Z.preventDefault(),
                    onCut: Z => Z.preventDefault(),
                    className: "bg-white border-gray-300 h-8 text-gray-900 font-light text-xs rounded-md shadow focus:ring-0 focus:border-black focus:border-[0.5px] border-[0.5px] block w-full  sm:w-1/2 p-2.5 my-2",
