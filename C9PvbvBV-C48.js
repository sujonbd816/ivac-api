...
` + H[0],
  ...
  , xw = ({setActiveStep: n}) => {
    ...
    children: [
        ...
        f.jsx("label", {
            className: "block text-sm font-medium text-gray-700 mb-2",
            children: o?.lblInputAppointDate?.[s] || "Select Appointment Date"
        }),
        // Select box
        f.jsxs("select", {
            id: "appointment_date",
            ...
            children: [
                ...
                f.jsx("option", {
                    ...
                    disabled: true,
                    hidden: true,
                    children: o?.lblInputAppointment?.[s] || "Select date"
                }),
                // Dynamic options from $
                $ && Object.keys($).length > 0 && Object.entries($).map(([ce, fe]) =>
                    f.jsx("option", {
                        value: fe,
                        children: fe
                    }, ce)
