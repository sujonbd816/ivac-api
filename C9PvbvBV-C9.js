...
const nj = ({message: n, type: l="info", onClose: s}) => {
  ...
  , uj = ({setStep: n}) => {
    ...
    children: (Vt = s?.verify_email)?.[l] || "Verify Email"
}),
f.jsx("button", {
    type: "button",
    onClick: _e,
    className: `text-xs font-medium rounded px-2 py-1.5 mr-2 mb-2 transition-colors duration-200
        text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 cursor-pointer`,
    children: (zt = s?.resendOtp)?.[l] || "Resend OTP"
}),
f.jsx("p", {
    ...
    children: [
        ...
        f.jsx("span", {
            className: "text-red-600 text-[10px]",
            children: "* " + ((ie = s?.lblNoCopyPaste)?.[l] || "")
        })
    ]
})
            }), f.jsx("input", {
            ...
            ${!Z || H ? "bg-gray-400 cursor-not-allowed" : "bg-[#28a745] hover:bg-[#218838]"}
            `,
            onClick: !H && Z ? G : void 0,
            children: H ? (Ln = s == null ? void 0 : s.checking) == null ? void 0 : Ln[l] : (on = s == null ? void 0 : s.lblProceed) == null ? void 0 : on[l]
        })]
    })
}
  , cj = ({setStep: n}) => {
  ...
  , uw = ({setStep: n}) => {
    ...
    return f.jsxs(oe.div, {
        ...
        children: [p && f.jsx(Rt, {
            ...
            children: g ? ((B = s == null ? void 0 : s.checking) == null ? void 0 : B[l]) + "..." : (F = s == null ? void 0 : s.lblProceed) == null ? void 0 : F[l]
        })]
    })
}
  , cw = ({setStep: n}) => {
